...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ManagedClusterServiceRegistryConfig) DeepCopyInto(out *ManagedClusterServiceRegistryConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ManagedClusterServiceRegistryConfig.
func (in *ManagedClusterServiceRegistryConfig) DeepCopy() *ManagedClusterServiceRegistryConfig {
	if in == nil {
		return nil
	}
	out := new(ManagedClusterServiceRegistryConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ManagedClusterServiceSpec) DeepCopy() *ManagedClusterServiceSpec {
	...
	out := new(ManagedClusterServiceSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ManagedClusterSpec) DeepCopyInto(out *ManagedClusterSpec) {
	*out = *in
	...
	if in.Services != nil {
		...
		*out = make([]ManagedClusterServiceSpec, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
